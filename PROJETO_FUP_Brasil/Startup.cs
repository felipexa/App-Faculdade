...
namespace PROJETO_FUP_Brasil
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<PROJETO_FUP_BrasilContext>(options =>
                    options.UseSqlServer(Configuration.GetConnectionString("PROJETO_FUP_BrasilContext")));
        }
